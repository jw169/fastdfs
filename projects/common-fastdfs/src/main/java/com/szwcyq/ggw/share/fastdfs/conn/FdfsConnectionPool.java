...
public class FdfsConnectionPool extends GenericKeyedObjectPool<InetSocketAddress, Connection>{
	...
	public FdfsConnectionPool(KeyedPooledObjectFactory<InetSocketAddress, Connection> factory, GenericKeyedObjectPoolConfig config){
		super(factory, fixConfig(config));
	}
	...
	public FdfsConnectionPool(KeyedPooledObjectFactory<InetSocketAddress, Connection> factory){
		super(factory, fixConfig(new GenericKeyedObjectPoolConfig()));
	}

	private static GenericKeyedObjectPoolConfig fixConfig(GenericKeyedObjectPoolConfig config){
		//config.setJmxNameBase("FdfsConnectionPool");
		//config.setJmxNamePrefix("FdfsConnectionPool");
